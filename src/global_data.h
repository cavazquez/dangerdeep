...
#define DBGOUT5(a, b, c, d, e) \
    do {                       \
    } while (0)
#define DBGOUT6(a, b, c, d, e, f) \
    do {                          \
    } while (0)
#define DBGOUT7(a, b, c, d, e, f, g) \
    do {                             \
    } while (0)
#define DBGOUT8(a, b, c, d, e, f, g, h) \
    do {                                \
    } while (0)
#else
...
template <class T>
inline T myclamp(const T &v, const T &minv, const T &maxv) { return std::min(maxv, std::max(minv, v)); }
template <class T>
