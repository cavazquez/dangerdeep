...
struct color {
    ...
    void store_rgb(Uint8 *ptr) const {
        ptr[0] = r;
        ptr[1] = g;
        ptr[2] = b;
    }
    void store_rgba(Uint8 *ptr) const {
        ptr[0] = r;
        ptr[1] = g;
        ptr[2] = b;
        ptr[3] = a;
    ...
    color grey_value() const {
        Uint8 c = (Uint8)(r * 0.299 + g * 0.587 + b * 0.114);
    ...
    color more_contrast(unsigned fac) const {
        ...
        return color(Uint8(rr > 255 ? 255 : rr < 0 ? 0
                                                   : rr),
                     Uint8(gg > 255 ? 255 : gg < 0 ? 0
                                                   : gg),
                     Uint8(bb > 255 ? 255 : bb < 0 ? 0
                                                   : bb));
    }
